...
from patches.training.visual_train import _active_env_count, parse_args
...
def test_visual_train_parse_args_defaults() -> None:
    ...
    assert args.steps_per_second == 4.0
    assert args.warmup_steps == 256
    assert args.checkpoint_dir == "checkpoints/patches_visual"
