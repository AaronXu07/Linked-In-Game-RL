"""Command-line DQN training entrypoint for Zip."""
...
def main() -> None:
    args = parse_args()
    if args.save_video_every:
        raise ValueError("video snapshots are not implemented yet")
    ...
    agent = ZipAgent(env, config, checkpoint_path=args.checkpoint_path)
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--checkpoint-dir", default="checkpoints/zip_super_easy")
    ...
    parser.add_argument("--log-dir", default="runs/zip_super_easy")
...
def _save_interrupted_checkpoint(agent: ZipAgent, checkpoint_dir: str | Path | None) -> None:
